...
class User(Base):
    ...
    organization_memberships: Mapped[list["OrganizationMembers"]] = relationship(back_populates="user")
...
class OrganizationMembers(Base):
    ...
    roles: Mapped[OrganizationRole] = mapped_column(SAEnum(OrganizationRole), default=OrganizationRole.MEMBER, nullable=False)
